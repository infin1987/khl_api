...
class RefsTntFilteredQuery(RefsTntQuery):
    pass


class RefsGamesQuery(RefsTntQuery):
    pass


class RefsGamesFilteredQuery(RefsGamesQuery):
    pass
