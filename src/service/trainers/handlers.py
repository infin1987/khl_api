...
from service.refs.helpers import ModelSchemaHelper


async def get_trainers_stats_by_metric(
        trainer_id: int,
    ...
    if "team_status" in query_params.keys() or "time_period" in query_params.keys() or "net" in query_params.keys():
        ...
        ands_obj = helper_obj.filter_params_for_where_orm_objects(query_params=query_params, id_filter=trainer_id)
