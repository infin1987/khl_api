...
from service.arenas.helpers import ModelSchemaHelper


async def get_arenas_stats_by_metric(
        arena_id: int,
    ...
    if "team_status" in query_params.keys() or "time_period" in query_params.keys() or "net" in query_params.keys():
        ...
        ands_obj = helper_obj.filter_params_for_where_orm_objects(query_params=query_params, id_filter=arena_id)
