...
from apiKhl.auth.dependencies import db_dep, oauth2_dep
...
async def get_current_user(
    ...
    print(get_current_user.__name__, ' called')
...
async def refreshTokens(
    ...
    if not user_dict:
        raise credentialException
    if refresh_token in bad_refresh_tokens:
        raise tokenExpiredException
    bad_refresh_tokens.append(refresh_token)
    # TODO: put Redis or DB call here
